...
public class TraktApi
{
    ...
    /// </summary>
    /// <param name="traktUser">The <see cref="TraktUser"/>.</param>
    /// <param name="username">The Trakt username. If null, uses "me" to get authenticated user's lists.</param>
    /// <returns>Task{List{DataContracts.Lists.TraktList}}.</returns>
    public async Task<List<DataContracts.Lists.TraktList>> SendGetUserListsRequest(TraktUser traktUser, string username = null)
    {
        var url = TraktUris.UserLists.Replace("{username}", username ?? "me", StringComparison.InvariantCulture);
        return await GetFromTrakt<List<DataContracts.Lists.TraktList>>(url, traktUser).ConfigureAwait(false);
    }
    ...
    /// <param name="username">The Trakt username. If null, uses "me" to get authenticated user's list.</param>
    /// <returns>Task{List{DataContracts.Lists.TraktListItem}}.</returns>
    public async Task<List<DataContracts.Lists.TraktListItem>> SendGetListItemsRequest(TraktUser traktUser, string listId, string username = null)
    {
        var url = TraktUris.ListItems
            .Replace("{username}", username ?? "me", StringComparison.InvariantCulture)
            .Replace("{id}", listId, StringComparison.InvariantCulture);
        return await GetFromTrakt<List<DataContracts.Lists.TraktListItem>>(url, traktUser).ConfigureAwait(false);
    }
