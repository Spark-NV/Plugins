...
public class TraktUser
{
    ...
    /// <summary>
    /// Gets or sets the selected Trakt list ID.
    /// </summary>
    public string SelectedListId { get; set; }

    /// <summary>
    /// Gets or sets the target library folder path for creating movie stub files.
    /// </summary>
    public string StubMovieLibraryPath { get; set; }

    /// <summary>
    /// Gets or sets the target library folder path for creating TV show stub files.
    /// </summary>
    public string StubTvLibraryPath { get; set; }
}
