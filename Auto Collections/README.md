...
used:
DC Movies:
MOVIE AND GENRE "Action" AND (STUDIO "DC" OR STUDIO "DC Entertainment" OR STUDIO "DC Films" OR STUDIO "DC Studios" OR TAG "DC" OR TAG "DC Comics" OR TITLE "Batman" OR TITLE "Superman" OR TITLE "Wonder Woman" OR TITLE "Aquaman" OR TITLE "Shazam" OR TITLE "Black Adam" OR TITLE "The Flash" OR TITLE "Green Lantern" OR TITLE "Justice League" OR TITLE "Suicide Squad" OR TITLE "Birds of Prey" OR TITLE "Constantine" OR TITLE "V for Vendetta" OR TITLE "Watchmen")

Marvel Movies:
MOVIE AND GENRE "Action" AND (STUDIO "Marvel Studios" OR STUDIO "Marvel Entertainment" OR TAG "Marvel" OR TAG "MCU" OR TAG "Marvel Comics" OR TITLE "Spider-Man" OR TITLE "Spiderman" OR TITLE "Venom" OR TITLE "Morbius" OR TITLE "X-Men" OR TITLE "Wolverine" OR TITLE "Deadpool" OR TITLE "Fantastic Four" OR TITLE "Punisher" OR TITLE "Daredevil" OR TITLE "Elektra" OR TITLE "Ghost Rider" OR TITLE "Blade" OR TITLE "Hulk")